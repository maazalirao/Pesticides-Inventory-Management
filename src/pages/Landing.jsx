    ...
    >
      ...
      <header
        className={`sticky top-0 z-50 transition-all duration-300 w-full ${
          scrolled ? "py-3 bg-slate-900/90 backdrop-blur-md shadow-lg" : "py-6"
        }`}
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2" data-aos="fade-right">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-xl">
              A comprehensive solution for tracking and managing agricultural
              chemicals, with both admin dashboard and customer store
              interfaces.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <SignedIn>
                <Link
                  to="/admin"
                  className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-semibold transition-all shadow-lg hover:shadow-orange-500/30 flex items-center justify-center"
                >
          ...
          <div className="md:w-1/2" data-aos="fade-left">
            <div className="relative">
              ...
              <div
                className="absolute -right-6 -bottom-6 w-24 h-24 bg-orange-500/20 rounded-2xl animate-pulse"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute -right-2 -top-2 w-16 h-16 bg-blue-500/20 rounded-full animate-pulse"
                style={{ animationDelay: "0.5s" }}
              ></div>
              <div
                className="absolute -left-2 -bottom-2 w-16 h-16 bg-blue-500/20 rounded-full animate-pulse"
              ...
              <div className="relative bg-white/5 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-white/10 p-6 rounded-lg hover:bg-white/15 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 flex flex-col items-center text-center group">
                    ...
                    <p className="text-sm text-slate-300">
                      Track product stock and locations
                    </p>
                  </div>
                  <div className="bg-white/10 p-6 rounded-lg hover:bg-white/15 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 flex flex-col items-center text-center group">
                    <div className="relative">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-bold mt-4">
            Complete Inventory & Sales Solution
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 group">
            ...
            <p className="text-slate-300">
              Real-time monitoring of product stock levels, locations, and
              movements. Get alerts for low stock products.
            </p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 group">
            ...
            <p className="text-slate-300">
              ...
              online with a seamless checkout process.
            </p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 group">
            ...
            <p className="text-slate-300">
              Detailed insights into sales, inventory levels, and business
              performance with exportable reports.
            </p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 group">
            ...
            <p className="text-slate-300">
              Role-based access management ensures that users only access what
          ...
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition hover:shadow-lg hover:shadow-orange-500/5 hover:scale-105 group">
            ...
            <p className="text-slate-300">
              Seamlessly connects inventory management with online store
              operations for a unified experience.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              Get started today with our comprehensive solution for managing
              your agricultural products inventory and online store.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <SignedIn>
                <Link
                  to="/admin"
                  className="px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-semibold transition shadow-xl flex items-center justify-center"
                >
                  <ShieldCheck className="mr-2 h-5 w-5" />
                  Go to Dashboard
                </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-slate-400 text-sm">
              &copy; {new Date().getFullYear()} Pesticide Inventory Management
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  ...
                  <SignedOut>
                    <SignInButton mode="modal">
                      <button className="text-slate-400 hover:text-orange-400 transition-colors text-left">
                        Admin Login
                      </button>
                    </SignInButton>
                  </SignedOut>

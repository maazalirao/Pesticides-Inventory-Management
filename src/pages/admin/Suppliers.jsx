  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        setSuppliers(
          suppliers.map((s) => (s._id === currentSupplierId ? result : s))
        );
      } else {
        ...
        console.log(
          "supplier is being created:",
          JSON.stringify(supplierWithUserId, null, 2)
        );

        result = await createSupplier(supplierWithUserId);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="hidden md:block text-2xl md:text-3xl font-bold tracking-tight">
            Supplier Management
          </h1>
